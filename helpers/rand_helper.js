const rnd = (ln = 5, typ = "num") => {
    ...
    const cL = ch.length;
    for (let i = 0; i < ln; i++) {
        res += ch.charAt(Math.floor(Math.random() * cL));
    }
    return res;
};

const uuid = (v = "", time = true, data1 = "", data2 = "") => {
    let uu;
    if (v === "v1") {
